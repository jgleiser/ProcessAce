...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    const workspaceSettingsLink = document.getElementById('workspaceSettingsLink');
    ...
    try {
        ...
        if (res.ok) {
            ...
            if (window.location.pathname !== '/login.html' && window.location.pathname !== '/register.html' && window.location.pathname !== '/accept-invite.html') {
                window.location.href = '/login.html';
            }
        }
    } catch (err) {
