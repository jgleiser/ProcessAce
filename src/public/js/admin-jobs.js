 ...
 */
function renderArtifactContent(type, content, _artifactId) {
  // currentArtifactId = artifactId; // Removed unused
  // currentArtifactContent = content; // Removed unused
  // currentArtifactType = type; // Removed unused
...
// function destroyDocEditor() { ... } // Removed dead code
